export default function WhoItHelps() {
  const segments = [
    ...
    { icon: "💼", label: "Desk Workers", headline: "Your neck pain keeps coming back because the signal is missing.", detail: "Built for the person whose neck, shoulders, or lower back tighten up no matter how often they stretch. The compensating muscles keep getting loaded because the real muscles aren't firing.", href: null },
    ...
    { icon: "🏋️", label: "Active Adults", headline: "Keep lifting, training, golfing without constantly managing flare-ups.", detail: "For people who want to stay active and strong without recurring tightness becoming the limiting factor. Neuromuscular gaps catch up with everyone eventually.", href: null },
