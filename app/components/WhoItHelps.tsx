export default function WhoItHelps() {
  const segments = [
    { icon: "⛳", label: "Golfers", headline: "Your swing isn't limited by flexibility — it's limited by muscles that have lost their signal.", detail: "For players restricted through the backswing, struggling to clear the hips, or wanting a body that can support a better swing. Rotation problems are often neuromuscular, not structural." },
    { icon: "🏃", label: "Runners", headline: "Tight muscles are compensating for muscles that stopped firing.", detail: "Helpful for recurring hip, knee, IT band, and low-back issues when mobility and strength work haven't fully solved the pattern. MAT finds which muscles went offline." },
    { icon: "💼", label: "Desk Workers", headline: "Your neck pain keeps coming back because the signal is missing.", detail: "Built for the person whose neck, shoulders, or lower back tighten up no matter how often they stretch. The compensating muscles keep getting loaded because the real muscles aren't firing." },
    { icon: "🏥", label: "Post-Surgery", headline: "We restore the signal to muscles your body shut down after surgery.", detail: "After injury or surgery, the nervous system inhibits muscles around the area. MAT identifies which ones lost their signal and gets them communicating again." },
    { icon: "🏋️", label: "Active Adults", headline: "Keep lifting, training, golfing — without constantly managing flare-ups.", detail: "For people who want to stay active and strong without recurring tightness becoming the limiting factor. Neuromuscular gaps catch up with everyone eventually." },
    { icon: "🎯", label: "Told 'Everything Looks Fine'", headline: "Imaging shows structure. MAT looks at the signal.", detail: "A muscle can test clean on an MRI and still not communicate properly with the brain. That neurological gap is exactly what MAT addresses — and what most imaging misses." },
  ];
  return (
