export default function WhoItHelps() {
  const segments = [
    ...
    { icon: "🎯", label: "Told 'Everything Looks Fine'", headline: "Imaging shows structure. MAT looks at the signal.", detail: "A muscle can test clean on an MRI and still not communicate properly with the brain. That neurological gap is exactly what MAT addresses, which most imaging misses." },
  ];
  return (
