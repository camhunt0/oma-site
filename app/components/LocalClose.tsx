    ...
    <section id="about" style={{ padding: "100px 48px", background: "var(--bg)", borderTop: "1px solid var(--border)" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "72px 80px", alignItems: "start" }}>
          <div>
            <div style={{ width: "100%", aspectRatio: "3/2", overflow: "hidden", border: "1px solid var(--border)", marginBottom: 2 }}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1523.4!2d-83.0685!3d40.1578!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8838eed4acf88b53%3A0x847a7f3c69cc6c0e!2s10516%20Sawmill%20Pkwy%20%23B%2C%20Powell%2C%20OH%2043065!5e0!3m2!1sen!2sus!4v1"
                width="100%"
                height="100%"
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-body)", fontSize: "0.97rem", color: "var(--muted)", lineHeight: 1.8, marginBottom: 28 }}>
              Cameron founded OMA after his own experience with sciatica made clear that most treatment approaches address the symptom, not the neurological source. That firsthand understanding shapes every session — he knows what it feels like to do the usual things and stay stuck, and what it feels like when the right muscles finally come back online.
            </p>
