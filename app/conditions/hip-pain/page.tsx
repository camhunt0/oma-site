...
const bookingHref = "https://ohiomuscleactivation.com/#booking";
      ...
      <main style={{ paddingTop: 66 }}>
        <section style={{ padding: "80px 48px 72px", background: "#0d0d0d", borderBottom: "2px solid var(--red)", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
            <a href="https://ohiomuscleactivation.com/#who-it-helps" style={{ fontFamily: "var(--font-body)", fontSize: "0.7rem", color: "var(--dim)", textDecoration: "none", letterSpacing: "0.08em", textTransform: "uppercase", display: "inline-flex", alignItems: "center", gap: 6, marginBottom: 28 }}>Back to Who It Helps</a>
        ...
        <section style={{ padding: "88px 48px", background: "var(--surface)", borderTop: "1px solid var(--border)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px 100px", alignItems: "center" }}>
            ...
            <div>
              ...
              <p style={{ ...bodyText, marginBottom: 28 }}>The first appointment is a Muscle Check Diagnotic: a focused evaluation to identify exactly which muscles have lost their signal and what that is causing in your hip. You will leave with a clear picture of the problem and a recommendation for next steps.</p>
